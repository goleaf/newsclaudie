...
- 📖 **[Usage Guide](COMMENT_MODEL_USAGE_GUIDE.md)** - Practical examples and patterns
- 🔧 **[API Reference](COMMENT_MODEL_API.md)** - Complete method documentation
- ⚡ **[Performance Guide](COMMENT_MODEL_PERFORMANCE_GUIDE.md)** - Optimization strategies

### For Architects
- 🏗️ **[Architecture](COMMENT_MODEL_ARCHITECTURE.md)** - Database design and patterns
...
2. [Usage Guide](COMMENT_MODEL_USAGE_GUIDE.md) - 15 min read
3. [API Reference](COMMENT_MODEL_API.md) - Reference material

### Understanding the System
1. [Architecture](COMMENT_MODEL_ARCHITECTURE.md) - Database design
...
```
📖 See: [Usage Guide - Creating Comments](COMMENT_MODEL_USAGE_GUIDE.md#creating-a-comment)
...
```
📖 See: [API Reference - Spam Detection](COMMENT_MODEL_API.md#spam-detection)

### Approving with Audit Trail
```php
$comment->approve(auth()->user());
```
📖 See: [Usage Guide - Moderation](COMMENT_MODEL_USAGE_GUIDE.md#single-comment-approval)

### Query Scopes
```php
Comment::forPost($post)->approved()->latest()->get();
```
📖 See: [API Reference - Query Scopes](COMMENT_MODEL_API.md#query-scopes)
...
📖 See: [Architecture - Performance](COMMENT_MODEL_ARCHITECTURE.md#performance-benchmarks)
...
📖 See: [Usage Guide - Best Practices](COMMENT_MODEL_USAGE_GUIDE.md#best-practices)
...
📖 See: [Usage Guide - Troubleshooting](COMMENT_MODEL_USAGE_GUIDE.md#troubleshooting)

**Issue**: N+1 query problem  
**Solution**: Use eager loading with `with()`  
📖 See: [Architecture - N+1 Prevention](COMMENT_MODEL_ARCHITECTURE.md#avoiding-n1-queries)

**Issue**: Soft deleted comments appearing  
**Solution**: Soft deletes are automatic, check query scopes  
📖 See: [API Reference - Soft Deletes](COMMENT_MODEL_API.md#soft-deletes)
...
2. Search the [Usage Guide](COMMENT_MODEL_USAGE_GUIDE.md)
3. Review the [API Reference](COMMENT_MODEL_API.md)
4. Check [Troubleshooting](COMMENT_MODEL_USAGE_GUIDE.md#troubleshooting)
...
2. Review [Usage Guide - Common Workflows](COMMENT_MODEL_USAGE_GUIDE.md#common-workflows) (15 min)
3. Try examples in your local environment (10 min)

### Intermediate (1 hour)
1. Study [API Reference](COMMENT_MODEL_API.md) (30 min)
2. Review [Schema Diagram](COMMENT_MODEL_SCHEMA_DIAGRAM.md) (15 min)
3. Explore test files (15 min)

### Advanced (2 hours)
1. Deep dive into [Architecture](COMMENT_MODEL_ARCHITECTURE.md) (45 min)
