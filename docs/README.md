...
- Run `npm run docs:verify` to automatically move stray Markdown into the right docs folders, update links, check for broken Markdown links, and verify nothing is left outside the `docs/` tree.
