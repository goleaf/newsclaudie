                ...
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="name" name="name" :value="old('name')" type="text" class="block mt-1 w-full" maxlength="255" required autofocus placeholder="{{ __('Category name') }}"/>
                            @error('name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>

                        <div class="mb-4">
                            <x-label for="slug" :value="__('Slug*')" />
                            <x-input id="slug" name="slug" :value="old('slug')" type="text" class="block mt-1 w-full" maxlength="255" required placeholder="{{ __('category-slug') }}"/>
                        ...
                        <div class="mb-6">
                            ...
                            <x-textarea id="description" name="description" class="block mt-1 w-full" rows="4" placeholder="{{ __('Category description (optional)') }}">{{ old('description') }}</x-textarea>
