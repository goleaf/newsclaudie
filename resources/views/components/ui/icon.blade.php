...
// Icon definitions - using Heroicons outline style
$icons = [
    // Navigation
...
$iconPath = $icons[$name] ?? $icons['exclamation-circle'];
@endphp

<svg {{ $attributes->class([$sizeClass, 'inline-block']) }} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke-width="1.5">
    {!! $iconPath !!}
</svg>
