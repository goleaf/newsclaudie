...
#### Main Documentation (`docs/POST_QUERY_SCOPES.md`)
...
#### Quick Reference (`docs/POST_QUERY_SCOPES_QUICK_REFERENCE.md`)
...
### Created Files (5)
1. `docs/POST_QUERY_SCOPES.md` - Main documentation (400+ lines)
2. `docs/POST_QUERY_SCOPES_QUICK_REFERENCE.md` - Quick reference (100+ lines)
...
### For Developers
1. Start with `docs/POST_QUERY_SCOPES_QUICK_REFERENCE.md` for quick lookup
2. Read `docs/POST_QUERY_SCOPES.md` for comprehensive understanding
